...
/* MOON DRAWING SCALE. True mean distance is 60.3 Earth radii, four times
   outside even the wide magnetosphere framing, which is why the Moon has
   been drawn correctly and never once been on screen. Distance is
   compressed to 13 Re — beyond the magnetopause, which is true, and inside
   the wide frame — while the ratio to its own mean is preserved exactly,
   so perigee and apogee still read. Its SIZE needs no compression at all:
   the Moon is 0.273 Earth radii and that ratio is perfectly legible, so it
   is drawn true relative to Earth. Distance compressed, size honest. */
export const MOON_MEAN_DIST_KM = 384400;
export const MOON_RADIUS_KM = 1737.4;
export const MOON_DRAW_RE = 13;
export function moonDrawDistanceKm(trueDistKm, earthRadiusKm = 6371) {
