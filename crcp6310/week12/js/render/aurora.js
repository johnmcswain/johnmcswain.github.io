...
/* Brightened substantially: additive green at low alpha over a lit globe is
   nearly invisible to the eye, and 557.7 nm auroral emission is anything but
   subtle. Alphas roughly doubled, weights up, and the faint tier raised off
   the floor so the oval reads as a band rather than a stipple. */
const BUCKETS = [
  [0.06, 70, 235, 150, 170, 3.2],
  [0.26, 120, 255, 175, 225, 4.2],
  [0.50, 205, 255, 200, 255, 5.2],
  [0.74, 255, 165, 150, 255, 6.0],
  [1.10, 255, 232, 210, 255, 8.0],     // substorm breakup: brighter than quiet
];
