...
/* auroral intensity 0..1 at a geographic point */
export function ovalIntensity(kp, latDeg, lonDeg, subsolarLonDeg) {
  ...
  return Math.max(0, Math.min(1, band * night * (0.25 + kp / 9 * 0.75)));
}
